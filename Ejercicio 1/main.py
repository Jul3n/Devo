...
Vector=[-3, -4, 0, 1, 2, 3, 4, 5, 6, 28, 496, 8128, 12, 18, 20, -5, -1, 24, 30, 36, 40, 42, 48, 54, 56, 60, 66, 70, 72, 78, 80, 84, 88, 90, 96, 100, 102]

suma=0 #Inicialiación de la suma a cero.
print("Los valores menores a cero serán calculados en su VALOR ABSOLUTO.")
for valor in Vector: #Recorremos todo el vector de prueba.
    ...
    if suma < abs(valor): #Si la suma es menor al valor es DEFECTIVO.
        print("El valor ", valor, "es DEFECTIVO")
    elif suma == abs(valor): #Si la suma es igual al valor es PERFECTO.
